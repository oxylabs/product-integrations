...
public class BatchQuery {
    private static final String AUTH = "user:pass1"; //Don't forget to fill in user credentials
    ...
    public static void main(String[] args) throws IOException {
        ...
        URL url = new URL("https://data.oxylabs.io/v1/queries/batch");
        ...
        String payload = "{\"source\": \"amazon_search\", \"query\": [\"kettle\", \"fridge\", \"microwave\"], \"geo_location\": \"10005\", \"parse\": \"true\"}";
