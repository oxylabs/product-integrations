...
namespace retrieve_job_content
{
    class Program
    {
        public void RetrieveJobContent()
        {
            string requestUrl = "https://data.oxylabs.io/v1/queries/6732223599958054913/results";
