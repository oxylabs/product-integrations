...
use Oxylabs\ResidentialApi\ConsoleWriter;
use Oxylabs\ResidentialApi\FileManager;
use Oxylabs\ResidentialApi\ProxyFormatter;
use Oxylabs\ResidentialApi\WebsiteScraper;
...
const RETRIES_NUM = 3;
const PROXY_ADDRESS = 'pr.oxylabs.io:7777';
const URL_LIST_NAME = 'url_list_residential.txt';
